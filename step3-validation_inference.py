...
subprocess.run(["pip","install","collection"])
...
inference_model = load_model("./dataset/homerouter/v2.pth", len(train_dataset.dataset.cat_id_to_label))

# Running inference on a new image
test_image_path = "./dataset/homerouter/images/fd3074c7-IMG_4844.jpg"  # Replace with the path to your new image
...
#model.load_state_dict(torch.load("./dataset/homerouter/v2.pth"))
#model.eval()
...
onnx_model_path = "./dataset/homerouter/model_v1.onnx"
